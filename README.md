...
In this project I've written my own library that implements the basic standard C++ container classes: `list`, `map`, `array`, `queue`, `set`,`multiset`, `stack` and `vector`. Implementations provides a full set of standard methods and attributes for element handling, container capacity checking and iteration.

## Instructions for running

Include s21_containers.h in your file.

`#include "<Directory where the header resides>/s21_containers.h"`
...
- list : `s21::list<value_type>`

- map : `s21::map<key_type, value_type, comparator = default>`

- array : `s21::array<value_type, N>`

- queue : `s21::queue<value_type>`

- set : `s21::set<key_type, comparator = default>`

- multiset : `s21::multiset<key_type, comparator = default>`

- stack : `s21::stack<value_type>`

- vector : `s21::vector<value_type, allocator = std::allocator<T>>`

## Instruction for testing

Being in stl_containers/src folder run command `make test`

*Note: you need installed `pkg-config` for choosing flags for gtest library linking

## Instruction for gcovr test coverage

Being in stl_containers/src folder run command `make gcovr_report`
